...
<?php
$dest= $db->get_results("SELECT * FROM tour");
?>
<?php
$type='batch_table';
				$field='dest_id';
...
?>
<h3>Tour <?php echo $count_dest;?> <?php echo $view_dest_id;?> </h3>
<?php $ch_id='';
foreach($dest as $destination)
{
$ch_id.=$destination->t_id.',';
?>

<!--<input type='checkbox' name='dest_id[]' value='<?php echo $destination->t_id;?>'><?php echo $destination->t_t;?><br />!-->
<?php
...
if($id!='')
{
$dest= $db->get_row("SELECT * FROM tour WHERE t_id='$id'");
if($dest)
{
?>

<input type='checkbox' checked name='dest_id[]' value='<?php echo $dest->t_id;?>'><?php echo $dest->t_t;?><br />
<?php
}
}
...
if($chkid!='')
{
$dest= $db->get_row("SELECT * FROM tour WHERE t_id='$chkid'");
if($dest)
{
?>

<input type='checkbox' name='dest_id[]' value='<?php echo $dest->t_id;?>'><?php echo $dest->t_t;?><br />
<?php
...
<input type='hidden' name='b_tags' value='<?php echo $batch->b_tags;?>'>
...
<input data-date-format="MM/dd/yyyy" type="text" name="date"  value="<?php echo $date22 ;  ?>"></input>  
