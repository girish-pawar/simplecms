...
?>
<!-- <a href='../wildlife/users/login.php' >Login</a>	|
<a href="../wildlife/users/register.php" >Signup</a>|
<a href="../wildlife/users/contact.php" >Contact Us</a> -->
<?php
//session_start();
...
if($fgmembersite->Login())
   {
        $fgmembersite->RedirectToURL("../wildlife/contact.php");
		 }
...
<a href="../wildlife/users/register1.php" class="btn" >Sign up</a>
