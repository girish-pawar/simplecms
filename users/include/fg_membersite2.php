 							...
 							foreach($fieldsarray as $key=>$value)
							{
												...
												if($keys)
												{
																	...
																	if($value != '')
																	{
																			...
																			{
																								$validator->addValidation("$keys->title","email","Please fill in ".$keys->title.".");									
																				}elseif($keys->title == 'Contact Number')
																				{
																									$validator->addValidation("$keys->title","numeric","Please fill in ".$keys->title.".");
																					}elseif($keys->title == 'Name')
																				{
																									$validator->addValidation("$keys->title","alpha","Please fill in ".$keys->title.".");
																					}else{			
																		...
																		echo '	<span id="register_name_errorloc" class="error">Please insert value in :'.$keys->title.'</span></br/>';
																		//$validator = new FormValidator();
																		//$validator->addValidation("$keys->title","req","Please fill in ".$keys->title.".");
																	...
																	/*elseif($value != '')
																	{
																		...
																		//$validator->addValidatiecho 'error is:'.$error;on("$value","req","Please fill in ".$keys->title.".");
																		//break 1;
																	}*/
																/*	elseif(!$this->SaveToDatabase($fieldsarray))
																	{
										            return false;
										        }*/else{
																				echo 'noerror msg';										        	
									...
									$count = count($d);
												/*if($count == 5)
												{
																if(!$this->SaveToDatabase($fieldsarray))
																{
																        return false;
																}
												}*/
